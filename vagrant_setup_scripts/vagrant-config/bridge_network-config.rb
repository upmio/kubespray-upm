...
# Host physical interface attached to br0. This value is maintained by
# libvirt_kubespray_setup.sh so an existing cluster can safely reuse its
# installation-time bridge configuration.
